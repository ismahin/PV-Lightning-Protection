...
The physical model follows the protection-priority order with eight numbered Scopes: PV/MPPT, configurable indirect-lightning injection, SPD1 diversion, SPD2 diversion, supercapacitor buffering, relay thresholds/timing, input-versus-output voltage, and inverter/load. Double-click the **USER SETTINGS - DOUBLE CLICK** block, edit any inputs or thresholds in its five tabs, press **Apply** or **OK**, run, and then open Scopes `01` through `08`. No code editing or rebuild is needed for these changes.
